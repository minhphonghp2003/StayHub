...
namespace StayHub.Infrastructure.Migrations
{
    ...
    [Migration("20260227095440_createdbyuesr")]
    partial class createdbyuesr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.TMS.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.TMS.UnitGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PropertyUser", b =>
                {
                    b.HasOne("StayHub.Domain.Entity.TMS.Property", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.TMS.Unit", b =>
                {
                    b.HasOne("StayHub.Domain.Entity.TMS.UnitGroup", "UnitGroup")
                        .WithMany("Units")
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.TMS.UnitGroup", b =>
                {
                    b.HasOne("StayHub.Domain.Entity.TMS.Property", "Property")
                        .WithMany("UnitGroups")
