...
namespace StayHub.Infrastructure.Migrations
{
    ...
    [Migration("20260315032802_invoiceservciequantiy")]
    partial class invoiceservciequantiy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.FMS.InvoiceService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.PMM.Property", b =>
                {
                    ...
                    b.Property<DateTime?>("DefaultPaymentDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.CRM.Contract", b =>
                {
                    ...
                    b.HasOne("StayHub.Domain.Entity.PMM.Unit", "Unit")
                        .WithOne("Contract")
                        .HasForeignKey("StayHub.Domain.Entity.CRM.Contract", "UnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.CRM.Customer", b =>
                {
                    ...
                    b.HasOne("StayHub.Domain.Entity.Catalog.CategoryItem", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.FMS.Invoice", b =>
                {
                    b.HasOne("StayHub.Domain.Entity.Catalog.CategoryItem", "Reason")
                        .WithMany()
            ...
            modelBuilder.Entity("StayHub.Domain.Entity.FMS.InvoiceService", b =>
                {
                    b.HasOne("StayHub.Domain.Entity.FMS.Invoice", "Invoice")
                        .WithMany("Services")
