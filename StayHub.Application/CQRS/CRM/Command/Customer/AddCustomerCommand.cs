...
public record AddCustomerCommand(string Name, string Phone, string? Email, string? CCCD, int? GenderId, int? ProvinceId, int? WardId, int? UnitId, DateTime? DateOfBirth, string? Address, string? Image, string? Job) : IRequest<BaseResponse<bool>>;
